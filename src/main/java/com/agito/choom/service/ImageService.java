...
public class ImageService {
  ...
  public Image upload(String email, MultipartFile file) {
    ...
    String imageUrl = bucketComponent.presign(bucketKey, Duration.ofHours(24)).toString();

    JImage entity = JImage.builder().id(UUID.randomUUID()).filename(imageUrl).email(email).build();
